...
class Tile {
  ...
  void moveTo(Animation<double> parent, int x, int y) {
    Animation<double> curved = CurvedAnimation(parent: parent, curve:  const Interval(0.0, moveInterval));
  ...
  void bounce(Animation<double> parent) {
    ...
    ]).animate(CurvedAnimation(parent: parent, curve: const Interval(moveInterval, 1.0)));
  }
  ...
  void appear(Animation<double> parent) {
    size = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: parent, curve: const Interval(moveInterval, 1.0)));
  }
